...
function readConfig() {
    ...
    if (!fs.existsSync(iniPath)) {
        logDebug('Arquivo de configura��o INI n�o encontrado, usando padr�o.');
        return {
            url: 'https://api.transjoi.com.br:10443/webapp/',
            programa: '',
            ambiente: ''
    ...
    try {
        ...
        logDebug(`Arquivo de configura��o lido. url: ${config.Protheus?.url}, programa: ${config.Protheus?.programa}, ambiente: ${config.Protheus?.ambiente}`);
        return {
        ...
        logDebug('Erro ao ler arquivo de configura��o INI: ' + e.message);
        return {
            url: 'https://api.transjoi.com.br:10443/webapp/',
            programa: '',
            ambiente: ''
